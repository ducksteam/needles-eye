...
public class MainStage extends StageTemplate {
	...
	public void build() {
		...
		playButtonPressed = new Image(new Texture("ui/menu/play2.png"));
		instructionsButtonUnpressed = new Image(new Texture("ui/menu/instructions1.png"));
		instructionsButtonPressed = new Image(new Texture("ui/menu/instructions2.png"));
		optionsButtonUnpressed = new Image(new Texture("ui/menu/options1.png"));
		optionsButtonPressed = new Image(new Texture("ui/menu/options2.png"));
